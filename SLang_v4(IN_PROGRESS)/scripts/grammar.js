...
*/
var parser = (function(){
var o=function(k,v,o,l){for(o=o||{},l=k.length;l--;o[k[l]]=v);return o},$V0=[2,2],$V1=[1,4],$V2=[11,16],$V3=[2,5],$V4=[1,16],$V5=[1,20],$V6=[2,7],$V7=[1,31],$V8=[2,42],$V9=[2,44],$Va=[1,35],$Vb=[1,56],$Vc=[1,59],$Vd=[1,65],$Ve=[1,66],$Vf=[1,67],$Vg=[1,57],$Vh=[1,63],$Vi=[1,64],$Vj=[1,62],$Vk=[1,58],$Vl=[1,68],$Vm=[1,69],$Vn=[1,70],$Vo=[1,61],$Vp=[16,57],$Vq=[9,13,14,16,40,41,43,44,46,47,51,52,53,54,56,57,58,61,65,66,67,68,69,70,71,72,73,74,76,77,78],$Vr=[1,80],$Vs=[2,60],$Vt=[9,13,40,41,43,46,47,51,54,58,65,66,67,76],$Vu=[2,62],$Vv=[2,64],$Vw=[1,136];
var parser = {trace: function trace() { },
yy: {},
symbols_: {"error":2,"program":3,"decls":4,"PUBLIC":5,"CLASS":6,"DRIVER":7,"EXTENDS":8,"VAR":9,"LBRACE":10,"METHOD":11,"MAIN":12,"LPAREN":13,"RPAREN":14,"block":15,"RBRACE":16,"EOF":17,"class":18,"ivars":19,"methods":20,"PROTECTED":21,"method":22,"formals":23,"exp":24,"var_exp":25,"intlit_exp":26,"fn_exp":27,"app_exp":28,"prim1_app_exp":29,"prim2_app_exp":30,"if_exp":31,"let_exp":32,"print_exp":33,"print2_exp":34,"assign_exp":35,"this_exp":36,"new_exp":37,"method_call":38,"super_method_call":39,"THIS":40,"NEW":41,"csargs":42,"CALL":43,"DOT":44,"SUPER":45,"INT":46,"PRINT":47,"DQUOTE":48,"optional":49,"COLON":50,"SET":51,"EQ":52,"SEMICOLON":53,"LET":54,"bindings":55,"IN":56,"END":57,"FN":58,"THATRETURNS":59,"moreformals":60,"COMMA":61,"args":62,"prim1_op":63,"prim2_op":64,"ADD1":65,"NEG":66,"NOT":67,"PLUS":68,"MINUS":69,"TIMES":70,"DIV":71,"REM":72,"LT":73,"GT":74,"more_csargs":75,"IF":76,"THEN":77,"ELSE":78,"$accept":0,"$end":1},
terminals_: {2:"error",5:"PUBLIC",6:"CLASS",7:"DRIVER",8:"EXTENDS",9:"VAR",10:"LBRACE",11:"METHOD",12:"MAIN",13:"LPAREN",14:"RPAREN",16:"RBRACE",17:"EOF",21:"PROTECTED",40:"THIS",41:"NEW",43:"CALL",44:"DOT",45:"SUPER",46:"INT",47:"PRINT",48:"DQUOTE",50:"COLON",51:"SET",52:"EQ",53:"SEMICOLON",54:"LET",56:"IN",57:"END",58:"FN",59:"THATRETURNS",61:"COMMA",65:"ADD1",66:"NEG",67:"NOT",68:"PLUS",69:"MINUS",70:"TIMES",71:"DIV",72:"REM",73:"LT",74:"GT",76:"IF",77:"THEN",78:"ELSE"},
...
break;
case 28:
 this.$ = SLang.absyn.createSuperMethodCall($$[$0-3], $$[$0-1]); 
break;
case 29:
